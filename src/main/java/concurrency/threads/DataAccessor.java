...
/**
 * http://sycure.wordpress.com/2012/01/21/example-using-java-future-and-
 * countdownlatch/
 * 
 * @author zhane
 *
...
public class DataAccessor {
	...
	static {
		executor = new ThreadPoolExecutor(10, 50, 1000, TimeUnit.SECONDS, new ArrayBlockingQueue<Runnable>(1000));
	}
