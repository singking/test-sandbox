...
public class MultiWorkQueue implements WorkQueue {
	...
	/*
	 * Executes the given task in the future. Queues the task and notifies the
	 * waiting thread. Also it makes the Work assigner to wait if the queued
	 * task reaches to threshold
	 */
