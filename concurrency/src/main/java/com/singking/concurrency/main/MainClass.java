...
/**
 * http://today.java.net/article/2011/06/14/method-reducing-contention-and-
 * overhead-worker-queues-multithreaded-java-applications
 *
 */
public class MainClass {
	public static void main(String[] args) {
		...
		if (args.length != 3) {
			...
			System.out.println(" Usage -> java MainClass <Queue type> " + "<number of threads> <number of task>");
			System.exit(-1);
		}
